...
"""
  ...
  Modified for heppyy by Ezra Lesser (elesser@berkeley.edu)
"""
...
libs  = [
    'fastjet',
    'LundPlane',
    #'fastjetcontribfragile',  # all of fjcontrib
    'heppyy_groom'
    ]
...
class ProcessBase(common_base.CommonBase):
  ...
  def lund_coordinates_SD(self, jet_sd):
    ...
    sd_info = fj.contrib.get_SD_jet_info(jet_sd)
    dR = sd_info.dR
    z = sd_info.z
    pt = jet_sd.pt()
    kt = z*dR*pt
